        ...
        <div>
          ...
          <div className="flex gap-4 flex-wrap">
            <a
              ...
              className="bg-orange-500 text-white rounded-full py-2 px-4 border-2 hover:bg-orange-600 transition font-medium flex items-center gap-2"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-zinc-700 text-white rounded-full py-2 px-4 border-2 hover:bg-orange-500 transition font-medium flex items-center gap-2"
            >
