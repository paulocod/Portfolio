    ...
    return (
        <header className="my-12 grid grid-cols-3 gap-12 items-center">
            ...
            <div className="text-end">
                <a href="/Portfolio/files/software-engineer-backend.pdf" target="_blank" className="bg-orange-500 text-white rounded-full py-3 px-6 border-2 hover:bg-orange-600 transition">{InfoText.ResumeButton}</a>
            </div>
        </header>
    );
};
